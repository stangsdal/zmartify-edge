...
CREATE TABLE IF NOT EXISTS devices (
    ...
    site_id INTEGER,
    device_type TEXT NOT NULL DEFAULT 'hvac_ahc9000',
...
CREATE TABLE IF NOT EXISTS nilan_hvac_state (
    ...
    t1_intake_c DOUBLE PRECISION,
    t2_inlet_c DOUBLE PRECISION,
    t3_exhaust_c DOUBLE PRECISION,
    t4_outlet_c DOUBLE PRECISION,
    t7_inlet_c DOUBLE PRECISION,
    t8_outdoor_c DOUBLE PRECISION,
    t9_heater_c DOUBLE PRECISION,
    controller_board_temperature_c DOUBLE PRECISION,
    bus_version INTEGER,
    app_version_major TEXT,
    app_version_minor TEXT,
    app_version_release TEXT,
    humidity_pct DOUBLE PRECISION,
    co2_ppm INTEGER,
    filter_days_remaining INTEGER,
    filter_interval_days INTEGER,
    status TEXT,

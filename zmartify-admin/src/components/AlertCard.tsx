...
export function AlertCard({ title, detail, time, priority, onClick }: AlertCardProps) {
  return (
    <button
      type="button"
      className="rounded-2xl p-4 app-surface shadow-soft border border-slate-100 w-full text-left"
      onClick={onClick}
      disabled={!onClick}
    >

...
def create_device_domain_v2_router(
    ...
    def require_hvac_permission(device_id: str, request: Request, permission: str) -> None:
        ...
        try:
            require_site_permission(auth_user, site_id, product_type="hvac", permission=permission)  # type: ignore[arg-type]
    ...
    def v2_device_zones(device_id: str, request: Request) -> list[dict]:
        require_hvac_permission(device_id, request, "read")
        try:
    ...
    def v2_rename_device_zone(device_id: str, zone_id: int, payload: ZoneRenameIn, request: Request) -> dict:
        require_hvac_permission(device_id, request, "configure")
        try:
